...
const registerSocketEvents = require("./socketEventRouter")
...
io.on("connection", (socket) => {
  ...
  socket.on("start-qualification", (data) => {
    console.log(data);
    qualificationController.startQualification(io,socket, data);
  });
  

  socket.on("submit-qualification-score", (data) => {
    qualificationController.submitScore(io,socket, data);
  });
